  ...
  return (
    <section className="py-24 px-4" id="testimonials">
      <div className="container mx-auto max-w-5xl">
        ...
        <div
          className={cn(
            "mt-20 opacity-0 transform translate-y-8 transition-all duration-1000 ease-out delay-300",
            isVisible && "opacity-100 transform-none"
          )}
        >
          ...
          <div className="flex justify-center items-center gap-8 flex-wrap max-w-3xl mx-auto">
            {clients.map((client, index) => (
              <div
                key={index}
                className="text-lg font-semibold text-gray-700 opacity-70 hover:opacity-100 transition-opacity"
              >
                {client}
              </div>
            ))}
