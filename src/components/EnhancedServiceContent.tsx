    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 mb-12 shadow-sm">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm">
              <div className="flex items-center mb-3">
                <Shield className="text-blue-500 mr-2 w-5 h-5" />
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm">
              <div className="flex items-center mb-3">
                <MessageCircle className="text-green-500 mr-2 w-5 h-5" />
      ...
      <section className="mb-16">
        <div className="text-center mb-10">
          <Badge className="mb-2">Why Choose Me</Badge>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl p-10 mb-12">
