...
export const siteMetadata = {
  ...
  description:
    "RDX Technologies is a remote product & engineering company — websites, form automation, and platforms for marketing agencies, service businesses, and education brands. Fixed projects from $1,000.",
